...
public class SzDataSourceDescriptorsImpl implements SzDataSourceDescriptors {
   ...
   *
   * @return The {@link SzDataSourceDescriptorsImpl} instance representing the {@link
   *         List} of {@link SzDataSourceDescriptor} instances.
   */
  public static SzDataSourceDescriptorsImpl valueOf(String text) {
    text = text.trim();
    ...
    if (first != '[' && last != ']') {
      ...
      if ((first == '"' && last == '"') || (first == '{' && last == '}')) {
        ...
        try {
          return SzDataSourceDescriptorsImpl.parseAsJsonArray("[" + text + "]");
      ...
      return SzDataSourceDescriptorsImpl.parseAsJsonArray(jsonText);
    }
   ...
   *
   * @param text The text to parse
   * @return The {@link SzDataSourceDescriptorsImpl} that was parsed.
   */
  private static SzDataSourceDescriptorsImpl parseAsJsonArray(String text) {
  ...
  public static void main(String[] args) {
    for (String arg : args) {
      ...
      try {
        SzDataSourceDescriptorsImpl descriptors = SzDataSourceDescriptorsImpl.valueOf(arg);
